...
var FirmwareView = React.createClass({
  mixins: [State, Navigation],
  propTypes: {
    show: React.PropTypes.bool.isRequired,
    context: React.PropTypes.string.isRequired,
    entity: React.PropTypes.object.isRequired,
    selectedfirmware: React.PropTypes.string.isRequired
  },

  handleClose: function() {
    ReactBootstrap.Dispatcher.emit(helpers.ucfirst(this.props.context) + 'form.setfirmware', 'close');
  },
  ...
  handleSubmit: function(e){
    ...
    ReactBootstrap.Dispatcher.emit("Nodeform.firmwareassign", this.props.entity,this.props.selectedfirmware,description);
    ReactBootstrap.Dispatcher.emit(helpers.ucfirst(this.props.context) + 'form.setfirmware', 'close');
  },
...
module.exports = withRouter(FirmwareView);
