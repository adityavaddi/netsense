...
var  sensorLooker = (site,node,from,to,sensor1,sensor2,fromtime,totime,timeZone)=> {
    var one_day = 1440 * 60;
    console.log("sensorLooker values",site,node,from,to,sensor1,sensor2,fromtime,totime,timeZone);
    console.log("testenergy",process.env.env_suffix,process.env.looker_production,process.env.looker_url);
    ...
    if(typeof hostname != "undefined"){
        ...
        hostnameDetails = 'analytics-dev1.sensity.com:9999';
    }
    ...
    if(lookerproduction == "true"){
        ...
        dashboardDetails = "/embed/dashboards/195?Siteid="+site+"&Nodeid="+node+"&Day="+from+" to "+to+"&Sensor1="+sensor1+"&Sensor2="+sensor2+"&Time="+fromtime+" to "+totime
    }   

    else if(lookerproduction == "false"){
        secretkeyDetails = 'e5cd8b70c442b247e9d564f3e12d2de79379796a40573b350f0ac2f3e3ad720e';
        dashboardDetails = "/embed/dashboards/231?Siteid="+site+"&Nodeid="+node+"&Day="+from+" to "+to+"&Sensor1="+sensor1+"&Sensor2="+sensor2+"&Time="+fromtime+" to "+totime
    }
    else {
    ...
    var lookerSensorDetails = {url:"https://" + url, hostnameDetails:hostnameDetails, lookerproduction1:lookerproduction };
    console.log("url in looker sensor",url);
    //return "https://" + url;
    return lookerSensorDetails;
}

exports.sensorLooker = sensorLooker;
