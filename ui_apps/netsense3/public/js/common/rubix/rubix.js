...
Rubix = function(id, opts) {
    ...
    this.tooltip.html("");
    this.tooltip.css({
        'font-family': 'Lato, "Lucida Grande", "NHaasGroteskDSPro-55Rg", Helvetica, sans-serif',
        'font-size': '12px',
        'position': 'absolute',
        'background': 'white',
        'color': '#89949B',
    ...
    this.title.css({
        'font-family': "Lato, 'Lucida Grande', NHaasGroteskDSPro-75Bd, Helvetica, sans-serif",
        'text-align': 'center',
        'user-select': 'none',
        'font-weight': 'bold',
        'font-size': '16px',
...
Rubix.prototype.callAxis = function(animate) {
    ...
    if(this.master_detail) {
        if(this.hasData) {
            ...
            if(this.yAxisGroup2) {
                this.yAxisGroup2.selectAll('text').style('font', (this.fontSize+1)+'px Lato, "Lucida Grande", "Lucida Sans Unicode", Verdana, "NHaasGroteskDSPro-55Rg", Helvetica, sans-serif').style('direction', 'ltr').style('fill', this.opts.tickColor).style('color', this.opts.tickColor).style('font-style', '').style('font-variant', '').style('font-weight', '').style('line-height', '');
                if(this.opts.theme_style === 'dark') {
                    this.yAxisGroup.selectAll('text').style('font-weight', 'bold');
                }
            }
...
Rubix.prototype._setupRoot = function() {
    ...
    if(!this.hasData) {
        this.canvas.append('text').attr('class', 'noData').attr('font-size', '30px').attr('text-anchor', 'middle').attr('transform', 'translate('+this.outerWidth/2+','+this.outerHeight/2+')').attr('font-family', 'Lato, "Lucida Grande", "NHaasGroteskDSPro-55Rg", Helvetica, sans-serif').text("No Data");
    } else {
        this.canvas.select('.noData').style('display', 'none');
    }
...
Rubix.prototype.resetFocus = function(forced) {
    ...
    if(this.axis.x.label.length) {
        ...
        this.xlabel.style('font-family', 'Lato, "Lucida Grande", "NHaasGroteskDSPro-75Bd", Helvetica, sans-serif');
    ...
    if(this.axis.y.label.length) {
        ...
        this.ylabel.style('font-family', 'Lato, "Lucida Grande", "NHaasGroteskDSPro-75Bd", Helvetica, sans-serif');
