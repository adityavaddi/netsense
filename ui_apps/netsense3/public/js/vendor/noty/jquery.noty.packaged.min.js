...
(this, function(a) {
    ...
    var b= {
        init:function(b) {
            ...
            , a.noty.defaults, b), this.options.layout=this.options.custom?a.noty.layouts.inline:a.noty.layouts[this.options.layout], a.noty.themes[this.options.theme]?this.options.theme=a.noty.themes[this.options.theme]:b.themeClassName=this.options.theme, delete b.layout, delete b.theme, this.options=a.extend( {}
            , this.options, this.options.layout.options), this.options.id="noty_"+(new Date).getTime()*Math.floor(1e6*Math.random()), this.options=a.extend( {}
            , this.options, b), this._build(), this
        }
        , _build:function() {
        ...
        , style:function() {
            ...
            switch(this.options.type) {
                ...
                case"warning":this.$bar.css( {
                    backgroundColor: "#FFBC3D", borderColor: "#FFC237", color: "#000000"
                }
                ), this.$buttons.css( {
                ...
                case"error":this.$bar.css( {
                    backgroundColor: "#ED7000", borderColor: "#ED7000", color: "#FFF"
                }
                ), this.$message.css( {
                    fontWeight: "bold"
                }
                ...
                case"information":this.$bar.css( {
                    backgroundColor: "#0088CE", color: "#FFF"
                }
                ), this.$buttons.css( {
                ...
                case"success":this.$bar.css( {
                    backgroundColor: "#00AC3E", borderColor: "#50C24E", color: "#FFF"
                }
                ), this.$buttons.css( {
