...
var  energyLooker = (site,node,from,to,fixture,schedule)=> {
   var one_day = 1440 * 60;
   ...
   if(lookerproduction == "true"){
       ...
       dashboardDetails = "/embed/dashboards/189?Siteid="+site+"&Node="+node+"&Days="+from+" to "+to+"&Fixtureid="+fixture+"&Scheduleid="+schedule
   }   

   else if(lookerproduction == "false"){
       secretkeyDetails = 'e5cd8b70c442b247e9d564f3e12d2de79379796a40573b350f0ac2f3e3ad720e';
       dashboardDetails = "/embed/dashboards/181?Siteid="+site+"&Node="+node+"&Days="+from+" to "+to+"&Fixtureid="+fixture+"&Scheduleid="+schedule
   }
   ...
   var lookerEnergyDetails = {url:"https://" + url, hostnameDetails:hostnameDetails, lookerproduction1:lookerproduction };
   //return "https://" + url;
   return lookerEnergyDetails;
}

exports.energyLooker = energyLooker;
