/**
 * Created by Senthil on 10/05/17.
 */
"use strict";
...
const uri = version + '/customers/uberorg/sites/ubersite/parkingpolicies/',
    tagUri = version + '/customers/uberorg/sites/ubersite/tags/';

let parkingPolicyTagData = {
    name: "New Policy Tag For Parking Policy",
    description: "New Parking Policy Tag"
};

let parkingPolicyData = {
    "name": "New Uber Parking Policy",
    "userId": "uberuser",
...
describe('Parking Policy', function () {
    describe('GET /customers/{orgid}/sites/{siteid}/parkingpolicies', function () {
        ...
        it("should create a policy tag using credentials", function (done) {
        ...
        it("should fail to create a parking policy for invalid siteid", function (done) {
        ...
        it("should fail to create a parking policy for invalid payload", function (done) {
        ...
        it('should get an empty list for all parking policies for invalid orgid', function (done) {
            var req = request.get(version + '/customers/XXXXX/sites/ubersite/parkingpolicies');
            agent.attachCookies(req);
        ...
        it('should get all parking policies with login credentials', function (done) {
    ...
    describe('GET /customers/{orgid}/sites/{siteid}/parkingpolicies/actions/search', function () {

        it('should fail to associate a tag to parking policy for incorrect tag id', function (done) {
            var data = {
                "tagids": [
                    'XXXXX'
                ]
        ...
        it('should associate a tag to parking policy with login credentials', function (done) {
            var data = {
                "tagids": [
                    policyTagId
                ]
        ...
        it('should get search results of parking policies by name with login credentials', function (done) {
            var data = {
                "name": "New Uber Parking Policy",
            }
            var req = request.post(uri + 'actions/search');
            agent.attachCookies(req);
            req.send(data)
                .set('Accept', 'application/json')
                .set('X-CSRF-Token', csrfToken)
                ...
                .end(function (err, res) {
                    ...
                    parkingPolicyData.tags.push(policyTagId);
                    delete result.policyId;
                    delete result.version;
                    delete result.createdOn;
                    delete result.lastUpdated;
        ...
        it('should get search results of parking policies by tag id with login credentials', function (done) {
            var data = {
                "tagid": policyTagId
            }            
            var req = request.post(uri + 'actions/search');
    ...
    describe('GET /customers/{orgid}/sites/{siteid}/parkingpolicies/{policyid}', function () {

        it("should fail to get parking policy for incorrect policyid", function (done) {
        ...
        it("should get parking policy using credentials", function (done) {
        ...
        it("should fail to update parking policy for incorrect payload", function (done) {
        ...
        it("should fail to update parking policy for incorrect policy id", function (done) {
        ...
        it("should update parking policy", function (done) {
            let updatedData = parkingPolicyData;
            updatedData.name = 'Updated Uber Parking Policy';
            let update_req = request.put(uri + parkingPolicyId);
            agent.attachCookies(update_req);
        ...
        it("should delete parking policy after", function (done) {
            ...
            delete_req.set('Accept', 'application/json')
                ...
                .expect(200)
                .end(function (err, res) {
                    console.log('Deleted Parking Policy:', parkingPolicyId);
                    should.not.exist(err);
                    done();
                });
        });
        ...
        it("should delete tag after", function (done) {
            ...
            delete_req.set('Accept', 'application/json')
                ...
                .expect(200)
                .end(function (err, res) {
                    console.log('Deleted Policy Tag:', policyTagId);
                    should.not.exist(err);
                    done();
                });
        });
