...
var testuser_id = null,
    testuser_email = 'test_user3@sensity.com',
    testuser_phone = '+14083421182',
    mqttClient = null,
    notification_id = null,
    coreNodeAlertId = null,
    videoNodeAlertId = null,
    coreNodeId = 'alertscorenodeid0014',
    videoNodeId = 'alertsvideonodeid0014',
    additionalEmails = ["test_additionalemail@sensity.com"];

describe('Notifications', function () {
    describe('email_and_sms', function () {
        describe('Send two emails and one sms', function () {
