...
import org.neo4j.driver.v1.{Config, Driver, GraphDatabase, _}
...
/**
  ...
  */
object Neo4jConnector extends Logging {
  ...
  implicit lazy val neo4jDriver = Neo4jConnector.driver.getOrElse(
    throw new IllegalArgumentException("Neo4J undefined"))

  lazy val neo4jSession = neo4jDriver.session()
  ...
  def closeConnection(): Unit ={
    try {
      ...
      case ex: Exception => log.warn("Error closing Neo4J Connection: " + ex.getMessage)
    }
  }
