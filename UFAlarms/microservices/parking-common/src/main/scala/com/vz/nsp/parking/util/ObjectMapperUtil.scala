...
import com.vz.nsp.parking.model.{AppRequest, MessageIdAndResponseTopic, RequestBody}
import com.vz.nsp.parking.CommonHelper.{generateAppRequestForValidationError}
