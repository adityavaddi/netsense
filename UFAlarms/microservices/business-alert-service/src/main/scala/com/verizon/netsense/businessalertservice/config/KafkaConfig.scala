...
object KafkaConfig extends Logging {
  ...
  var groupId = appconfig.getString("kafka.business-group-name")
  var requestTopicName = appconfig.getString("kafka.business-alert-request-topic-name")
  var responseTopicName = appconfig.getString("kafka.business-alert-request-response-topic-name")
