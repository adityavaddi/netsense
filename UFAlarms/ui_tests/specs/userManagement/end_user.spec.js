...
describe("New User Management UX panel ", ()=>{
    ...
    it('Save the Users details and wait for the pop up', (done) => {
        createUser.saveUser.click();
        browser.wait(until.textToBePresentInElement(createUser.notyContainer, 'User'), waitTimeout).then(function () {
            // It is visible  
            done();
        }, function () {
            done();
